...
public class HttpTests {
    ...
    public void testHttpURLConnectionGet() {
        String httpurl = "http://check.obsapp.com:20341/plugins";
    ...
    public void testHttpURLConnectionPost() {
        String httpUrl = "http://update15.xiaohulu.com:24571/danmupro/tycoon/list.php";
        String param = "pid=2&all=1&userName=大鱼&guid=bbabafb7-b1ee-488c-b73c-c9f488bd6433&token=2940C19E-7631-95CD-F0FA-35A087047429";
    ...
    public void testHttpClient3Get() {
        String url = "http://check.obsapp.com:20341/plugins";
    ...
    public void testHttpClient3Post() {
        String url = "http://update15.xiaohulu.com:24571/danmupro/tycoon/list.php";
        Map<String, Object> paramMap = new HashMap<>(){{
            put("pid", 2);
            put("all", 1);
            put("userName", "大鱼");
            put("guid", "bbabafb7-b1ee-488c-b73c-c9f488bd6433");
            put("token", "2940C19E-7631-95CD-F0FA-35A087047429");
        }};
