package pers.hai.simple.cipher;
...
public class PBE {
    ...
    // static byte[] salt = "xiaoyang".getBytes(); // 盐：Salt must be 8 bytes
    // long
    static byte[] salt = "哈皮aa".getBytes(); // 盐：Salt must be 8 bytes long
                                            // 哈皮，在utf8中是6个字节
    ...
    static byte[] encrypt(String str) throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, key,
                new PBEParameterSpec(salt, iterationCount));// 使用加密模式初始化 密钥
