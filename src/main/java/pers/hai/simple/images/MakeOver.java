...
public class MakeOver {
    ...
    public static void main(String[] args) {
        ...
        mo.CreateGIF("F:/IMG/GB/com.gif", "F:/IMG/GB/s.gif", "F:/IMG/GB/0/", 82, 395);
    ...
    public void CreateGIF(String outputFileName, String path1, String path2,
...
//            }
    ...
    public BufferedImage pressImage(String pressImg, String targetImg, int x,
            int y) {
        try {
            // 目标文件
